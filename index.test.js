import { sectorForRender1, sectorsConst} from 'stadio'
...
test.skip('get sector 1 data for render sector page', () => {
  initData();
...
test.skip('If I set tribune price then all children sectors shoud have this price', () => {
  initData();
